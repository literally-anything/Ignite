...
public struct InstanceTable: Sendable {
    ...
    /// The provided `drmFd` **must** correspond to the one owned by the `physicalDevice`.
    /// If not, the error code `VK_ERROR_UNKNOWN` **must** be returned.
    /// Mast⁠er permissions are not required, because the file descriptor is just used for information gathering purposes.
    ...
    /// ---
    /// - Precondition: `physicalDevice` **must** be a valid [VkPhysicalDevice](https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDevice.html) handle
    /// - Precondition: `pQueueFamilyDataGraphProcessingEngineInfo` **must** be a valid pointer to a valid [VkPhysicalDeviceQueueFamilyDataGraphProcessingEngineInfoARM](https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceQueueFamilyDataGraphProcessingEngineInfoARM.html) structure
    /// - Precondition: `pQueueFamilyDataGraphProcessingEngineProperties` **must** be a valid pointer to a [VkQueueFamilyDataGraphProcessingEnginePropertiesARM](https://registry.khronos.org/vulkan/specs/latest/man/html/VkQueueFamilyDataGraphProcessingEnginePropertiesARM.html) structure
    ///
    /// - SeeAlso: [vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM Documentation](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM.html)
    @unsafe
    public let getPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM:
    ...
    ///
    /// If `pQueueFamilyDataGraphProperties` is `NULL`, then the number of properties available is returned in `pQueueFamilyDataGraphPropertyCount`.
    /// Otherwise, `pQueueFamilyDataGraphPropertyCount` **must** point to a variable set by the application to the number of elements in the `pQueueFamilyDataGraphProperties` array, and on return the variable is overwritten with the number of structures actually written to `pQueueFamilyDataGraphProperties`.
    /// If `pQueueFamilyDataGraphPropertyCount` is less than the number of properties available, at most `pQueueFamilyDataGraphPropertyCount` structures will be written, and `VK_INCOMPLETE` will be returned instead of `VK_SUCCESS`, to indicate that not all the available properties were returned.
    ///
    /// - Parameters:
    ///   - physicalDevice: is the physical device to query.
    ...
    /// ---
    /// - Precondition: `physicalDevice` **must** be a valid [VkPhysicalDevice](https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDevice.html) handle
    /// - Precondition: `pQueueFamilyDataGraphPropertyCount` **must** be a valid pointer to a `uint32_t` value
    ...
    ///
    /// - SeeAlso: [vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM Documentation](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM.html)
    @unsafe
    public let getPhysicalDeviceQueueFamilyDataGraphPropertiesARM: PFN_vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM!
    ...
    @unsafe
    public var getPhysicalDeviceProperties2KHR: PFN_vkGetPhysicalDeviceProperties2! { unsafe getPhysicalDeviceProperties2 }
    ...
    internal init(getInstanceProcAddr: PFN_vkGetInstanceProcAddr, instance: VkInstance) {
        ...
        traceLog("Loading vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM command in InstanceTable")
        unsafe self.getPhysicalDeviceQueueFamilyDataGraphPropertiesARM = unsafeBitCast(
            getProcAddr(context, "vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM"),
            to: PFN_vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM.self
        )
        if unsafe self.getPhysicalDeviceQueueFamilyDataGraphPropertiesARM == nil {
            debugLog("Failed to load vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM command in InstanceTable")
        }

        traceLog("Loading vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM command in InstanceTable")
        unsafe self.getPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM = unsafeBitCast(
            getProcAddr(context, "vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM"),
            to: PFN_vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM.self
        )
        if unsafe self.getPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM == nil {
            debugLog(
                "Failed to load vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM command in InstanceTable"
            )
        }
