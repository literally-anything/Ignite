...
extension Instance {
    ...
    public struct InstanceTable: Sendable {
        ...
        // Generated 2025-04-26 04:30:25 +0000
        ...
        /// When using `VK_DEVICE_GROUP_PRESENT_MODE_LOCAL_MULTI_DEVICE_BIT_KHR`, the application **may** need to know which regions of the surface are used when presenting locally on each physical device. 
        /// Presentation of swapchain images to this surface need only have valid contents in the regions returned by this command.
        /// 
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkGetPhysicalDevicePresentRectanglesKHR Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDevicePresentRectanglesKHR.html)
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkGetPhysicalDeviceMultisamplePropertiesEXT Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceMultisamplePropertiesEXT.html)
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkGetPhysicalDeviceCalibrateableTimeDomainsKHR Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceCalibrateableTimeDomainsKHR.html)
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkGetPhysicalDeviceCooperativeMatrixPropertiesNV Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceCooperativeMatrixPropertiesNV.html)
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR.html)
        public let enumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR: PFN_vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR!
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR.html)
        public let getPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR: PFN_vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR!
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV.html)
        public let getPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV: PFN_vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV!
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkGetPhysicalDeviceToolProperties Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceToolProperties.html)
        ...
        /// Valid Usage
        /// ---
        /// - Precondition: If `pVideoProfile->videoCodecOperation` specifies a decode operation, then the `pNext` chain of `pCapabilities` **must** include a [VkVideoDecodeCapabilitiesKHR](https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoDecodeCapabilitiesKHR.html) structure
        /// - Precondition: If `pVideoProfile->videoCodecOperation` is `VK_VIDEO_CODEC_OPERATION_DECODE_H264_BIT_KHR`, then the `pNext` chain of `pCapabilities` **must** include a [VkVideoDecodeH264CapabilitiesKHR](https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoDecodeH264CapabilitiesKHR.html) structure
        /// - Precondition: If `pVideoProfile->videoCodecOperation` is `VK_VIDEO_CODEC_OPERATION_DECODE_H265_BIT_KHR`, then the `pNext` chain of `pCapabilities` **must** include a [VkVideoDecodeH265CapabilitiesKHR](https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoDecodeH265CapabilitiesKHR.html) structure
        /// - Precondition: If `pVideoProfile->videoCodecOperation` is `VK_VIDEO_CODEC_OPERATION_DECODE_AV1_BIT_KHR`, then the `pNext` chain of `pCapabilities` **must** include a [VkVideoDecodeAV1CapabilitiesKHR](https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoDecodeAV1CapabilitiesKHR.html) structure
        /// - Precondition: If `pVideoProfile->videoCodecOperation` specifies an encode operation, then the `pNext` chain of `pCapabilities` **must** include a [VkVideoEncodeCapabilitiesKHR](https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeCapabilitiesKHR.html) structure
        /// - Precondition: If `pVideoProfile->videoCodecOperation` is `VK_VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_KHR`, then the `pNext` chain of `pCapabilities` **must** include a [VkVideoEncodeH264CapabilitiesKHR](https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeH264CapabilitiesKHR.html) structure
        /// - Precondition: If `pVideoProfile->videoCodecOperation` is `VK_VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_KHR`, then the `pNext` chain of `pCapabilities` **must** include a [VkVideoEncodeH265CapabilitiesKHR](https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeH265CapabilitiesKHR.html) structure
        /// - Precondition: If `pVideoProfile->videoCodecOperation` is `VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR`, then the `pNext` chain of `pCapabilities` **must** include a [VkVideoEncodeAV1CapabilitiesKHR](https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeAV1CapabilitiesKHR.html) structure
        /// 
        /// Valid Usage (Implicit)
        /// ---
        /// - Precondition: `physicalDevice` **must** be a valid [VkPhysicalDevice](https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDevice.html) handle
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkGetPhysicalDeviceVideoCapabilitiesKHR Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceVideoCapabilitiesKHR.html)
        ...
        /// Valid Usage
        /// ---
        /// - Precondition: The `pNext` chain of `pVideoFormatInfo` **must** include a [VkVideoProfileListInfoKHR](https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoProfileListInfoKHR.html) structure with `profileCount` greater than `0`
        /// 
        /// Valid Usage (Implicit)
        /// ---
        /// - Precondition: `physicalDevice` **must** be a valid [VkPhysicalDevice](https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDevice.html) handle
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkGetPhysicalDeviceVideoFormatPropertiesKHR Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceVideoFormatPropertiesKHR.html)
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR.html)
        public let getPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR: PFN_vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR!
        ...
        /// 
        /// If `pImageFormatProperties` is `NULL`, then the number of optical flow properties supported for the given `physicalDevice` is returned in `pFormatCount`. 
        /// Otherwise, `pFormatCount` **must** point to a variable set by the application to the number of elements in the `pImageFormatProperties` array, and on return the variable is overwritten with the number of values actually written to `pImageFormatProperties`. 
        /// If the value of `pFormatCount` is less than the number of optical flow properties supported, at most `pFormatCount` values will be written to `pImageFormatProperties`, and `VK_INCOMPLETE` will be returned instead of `VK_SUCCESS`, to indicate that not all the available values were returned.
        /// 
        ...
        /// ---
        /// - Precondition: `physicalDevice` **must** be a valid [VkPhysicalDevice](https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDevice.html) handle
        /// - Precondition: `pOpticalFlowImageFormatInfo` **must** be a valid pointer to a valid [VkOpticalFlowImageFormatInfoNV](https://registry.khronos.org/vulkan/specs/latest/man/html/VkOpticalFlowImageFormatInfoNV.html) structure
        /// - Precondition: `pFormatCount` **must** be a valid pointer to a `uint32_t` value
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkGetPhysicalDeviceOpticalFlowImageFormatsNV Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceOpticalFlowImageFormatsNV.html)
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR.html)
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV.html)
        public let getPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV: PFN_vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV!
        ...
        /// 
        /// ### Documentation
        /// - SeeAlso: [vkGetPhysicalDeviceCooperativeVectorPropertiesNV Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceCooperativeVectorPropertiesNV.html)
        public let getPhysicalDeviceCooperativeVectorPropertiesNV: PFN_vkGetPhysicalDeviceCooperativeVectorPropertiesNV!
            ...
            /// 
            /// ### Documentation
            /// - SeeAlso: [vkAcquireWinrtDisplayNV Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkAcquireWinrtDisplayNV.html)
            ...
            /// 
            /// ### Documentation
            /// - SeeAlso: [vkGetWinrtDisplayNV Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetWinrtDisplayNV.html)
            ...
            /// 
            /// ### Documentation
            /// - SeeAlso: [vkGetPhysicalDeviceSurfacePresentModes2EXT Docs](https://registry.khronos.org/vulkan/specs/latest/man/html/vkGetPhysicalDeviceSurfacePresentModes2EXT.html)
        ...
        internal init(getInstanceProcAddr: PFN_vkGetInstanceProcAddr) {
            ...
            self.getPhysicalDevicePresentRectanglesKHR = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDevicePresentRectanglesKHR"),
                to: PFN_vkGetPhysicalDevicePresentRectanglesKHR.self
            )
            if self.getPhysicalDevicePresentRectanglesKHR == nil {
            ...
            self.getPhysicalDeviceMultisamplePropertiesEXT = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDeviceMultisamplePropertiesEXT"),
                to: PFN_vkGetPhysicalDeviceMultisamplePropertiesEXT.self
            )
            if self.getPhysicalDeviceMultisamplePropertiesEXT == nil {
            ...
            self.getPhysicalDeviceCalibrateableTimeDomainsKHR = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDeviceCalibrateableTimeDomainsKHR"),
                to: PFN_vkGetPhysicalDeviceCalibrateableTimeDomainsKHR.self
            )
            if self.getPhysicalDeviceCalibrateableTimeDomainsKHR == nil {
            ...
            self.getPhysicalDeviceCooperativeMatrixPropertiesNV = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDeviceCooperativeMatrixPropertiesNV"),
                to: PFN_vkGetPhysicalDeviceCooperativeMatrixPropertiesNV.self
            )
            if self.getPhysicalDeviceCooperativeMatrixPropertiesNV == nil {
            ...
            self.enumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR = unsafeBitCast(
                getInstanceProcAddr(nil, "vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR"),
                to: PFN_vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR.self
            )
            if self.enumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR == nil {
                debugLog("Failed to load vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR command in InstanceTable")
            }
            
            traceLog("Loading vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR command in InstanceTable")
            self.getPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR"),
                to: PFN_vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR.self
            )
            if self.getPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR == nil {
            ...
            self.getPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV"),
                to: PFN_vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV.self
            )
            if self.getPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV == nil {
                debugLog("Failed to load vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV command in InstanceTable")
            }
            
            traceLog("Loading vkGetPhysicalDeviceToolProperties command in InstanceTable")
            self.getPhysicalDeviceToolProperties = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDeviceToolProperties"),
                to: PFN_vkGetPhysicalDeviceToolProperties.self
            )
            if self.getPhysicalDeviceToolProperties == nil {
            ...
            self.getPhysicalDeviceFragmentShadingRatesKHR = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDeviceFragmentShadingRatesKHR"),
                to: PFN_vkGetPhysicalDeviceFragmentShadingRatesKHR.self
            )
            if self.getPhysicalDeviceFragmentShadingRatesKHR == nil {
            ...
            self.getPhysicalDeviceVideoCapabilitiesKHR = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDeviceVideoCapabilitiesKHR"),
                to: PFN_vkGetPhysicalDeviceVideoCapabilitiesKHR.self
            )
            if self.getPhysicalDeviceVideoCapabilitiesKHR == nil {
            ...
            self.getPhysicalDeviceVideoFormatPropertiesKHR = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDeviceVideoFormatPropertiesKHR"),
                to: PFN_vkGetPhysicalDeviceVideoFormatPropertiesKHR.self
            )
            if self.getPhysicalDeviceVideoFormatPropertiesKHR == nil {
            ...
            self.getPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR"),
                to: PFN_vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR.self
            )
            if self.getPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR == nil {
            ...
            self.getPhysicalDeviceOpticalFlowImageFormatsNV = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDeviceOpticalFlowImageFormatsNV"),
                to: PFN_vkGetPhysicalDeviceOpticalFlowImageFormatsNV.self
            )
            if self.getPhysicalDeviceOpticalFlowImageFormatsNV == nil {
            ...
            self.getPhysicalDeviceCooperativeMatrixPropertiesKHR = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR"),
                to: PFN_vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR.self
            )
            if self.getPhysicalDeviceCooperativeMatrixPropertiesKHR == nil {
            ...
            self.getPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV"),
                to: PFN_vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV.self
            )
            if self.getPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV == nil {
                debugLog("Failed to load vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV command in InstanceTable")
            }
            
            traceLog("Loading vkGetPhysicalDeviceCooperativeVectorPropertiesNV command in InstanceTable")
            self.getPhysicalDeviceCooperativeVectorPropertiesNV = unsafeBitCast(
                getInstanceProcAddr(nil, "vkGetPhysicalDeviceCooperativeVectorPropertiesNV"),
                to: PFN_vkGetPhysicalDeviceCooperativeVectorPropertiesNV.self
            )
            if self.getPhysicalDeviceCooperativeVectorPropertiesNV == nil {
                ...
                self.acquireWinrtDisplayNV = unsafeBitCast(
                    getInstanceProcAddr(nil, "vkAcquireWinrtDisplayNV"),
                    to: PFN_vkAcquireWinrtDisplayNV.self
                )
                if self.acquireWinrtDisplayNV == nil {
                ...
                self.getWinrtDisplayNV = unsafeBitCast(
                    getInstanceProcAddr(nil, "vkGetWinrtDisplayNV"),
                    to: PFN_vkGetWinrtDisplayNV.self
                )
                if self.getWinrtDisplayNV == nil {
                ...
                self.getPhysicalDeviceSurfacePresentModes2EXT = unsafeBitCast(
                    getInstanceProcAddr(nil, "vkGetPhysicalDeviceSurfacePresentModes2EXT"),
                    to: PFN_vkGetPhysicalDeviceSurfacePresentModes2EXT.self
                )
                if self.getPhysicalDeviceSurfacePresentModes2EXT == nil {
