...
typedef enum __attribute__((enum_extensibility(open))) VkDisplacementMicromapFormatNV {
...
typedef enum __attribute__((enum_extensibility(open))) VkCompressedTriangleFormatAMDX {
