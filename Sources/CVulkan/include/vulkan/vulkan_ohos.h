...
typedef enum __attribute__((enum_extensibility(open),flag_enum)) VkSurfaceCreateFlagsOHOS : VkFlags { VkSurfaceCreateFlagsOHOS_NONE __attribute__((deprecated)) = 0 }VkSurfaceCreateFlagsOHOS
#else
