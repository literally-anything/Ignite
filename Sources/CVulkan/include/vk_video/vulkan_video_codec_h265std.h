...
typedef enum __attribute__((enum_extensibility(open))) StdVideoH265ChromaFormatIdc {
...
typedef enum __attribute__((enum_extensibility(open))) StdVideoH265ProfileIdc {
...
typedef enum __attribute__((enum_extensibility(open))) StdVideoH265LevelIdc {
...
typedef enum __attribute__((enum_extensibility(open))) StdVideoH265SliceType {
...
typedef enum __attribute__((enum_extensibility(open))) StdVideoH265PictureType {
...
typedef enum __attribute__((enum_extensibility(open))) StdVideoH265AspectRatioIdc {
